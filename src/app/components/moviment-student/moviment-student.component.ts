...
@Component({
  selector: 'app-moviment-student',
  templateUrl: './moviment-student.component.html',
  styleUrls: ['./moviment-student.component.css']
})
export class MovimentStudentComponent {
...
this.getListOfRooms();
  ...
  getListOfRooms() {
    ...
    this.rentalService.getMovimentByStudent(student).subscribe({
      next: (response) => {
