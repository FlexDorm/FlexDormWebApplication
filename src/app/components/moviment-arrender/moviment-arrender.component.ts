...
@Component({
  selector: 'app-moviment-arrender',
  templateUrl: './moviment-arrender.component.html',
  styleUrls: ['./moviment-arrender.component.css']
})
export class MovimentArrenderComponent  {
...
this.getListOfRooms();
  ...
  getListOfRooms() {
    ...
    this.rentalService.getMovimentByArrender(arrender).subscribe({
      next: (response) => {
